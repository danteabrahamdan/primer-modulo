...
<head>
  <meta charset="UTF-8">
	...
	<title>Lista Pañoleta</title>
</head>
<body>
	
	<form method="POST" action="GUARDAR_P.php">
		<div class="container column-wrapper">
			<div class="content new-content">
				<span>LISTADO TOTAL</span>
				<?php
					require "conectar3.php";
					$consulta = "SELECT * FROM itemcuello";
					...
					";
				?>
				<a href="./form_Registra_P" class="btn-add"><img src="../assets/icons/add.svg" alt="add" class="btn-add-svg"></a>
			</div>
